...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay ref={ref} className={cn("fixed inset-0 z-50 bg-background/35", className)} {...props} />
));
...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-y-0 right-0 z-50 h-full w-[min(720px,calc(100vw-24px))] border-l bg-background shadow-drawer transition ease-drawer",
        className
      )}
      {...props}
    >
